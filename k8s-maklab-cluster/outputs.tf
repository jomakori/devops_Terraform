# Stale: kubeconfig output was for the minikube cluster via the old Tailscale
# tunnel. The cluster is now exposed via the Tailscale k8s operator apiserver
# proxy — clients use `tailscale configure kubeconfig` instead.
# locals {
