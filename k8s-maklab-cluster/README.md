...
| <a name="input_kubernetes_version"></a> [kubernetes\_version](#input\_kubernetes\_version) | Kubernetes version to use for k8s cluster. For latest version, run `minikube config defaults kubernetes-version` | `string` | `"v1.33.1"` | no |
